...
export class ProductService {
  ...
  getAllProducts(): Observable<any[]> {
    return this.http.get<any[]>("http://localhost:4200/GetAllProducts");
  }
  getAllProductsByCateogry(id: number): Observable<any[]> {
    return this.http.get<any[]>("http://localhost:4200/GetAllProductsByCategoryId?id="+ id);
  }

  getAllCategory(): Observable<any[]> {
    return this.http.get<any[]>("http://localhost:4200/GetAllCategory");
  }
